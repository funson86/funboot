...
<section class="page-section bg-white">
    <div class="container-fluid">
        ...
        <div class="row featurette text-center">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-6 mb-4 wow pulse"><iframe src="//player.bilibili.com/player.html?aid=721011075&bvid=BV1eQ4y1B7LK&cid=423821240&page=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" height="300"> </iframe> </iframe> <?= Html::a('大屏观看', 'https://www.bilibili.com/video/BV1eQ4y1B7LK', ['class' => '', 'target' => '_blank']) ?></div>
        </div>
