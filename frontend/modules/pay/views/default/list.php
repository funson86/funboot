                ...
                <div class="card-body">
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            'money',
                            'remark',
                            ['attribute' => 'status', 'format' => 'raw', 'value' => function ($model) { return Html::color($model->status, Payment::getStatusLabels($model->status), [Payment::STATUS_PAID], [Payment::STATUS_EXPIRED], [Payment::STATUS_INACTIVE]); }, 'filter' => false, ],
