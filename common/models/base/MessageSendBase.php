...
/**
 * This is the model base class for table "{{%base_message_send}}" to add your code.
 *
 * @property User $user
 ...
 * @property User $from
 */
class MessageSendBase extends BaseModel
{
    const STATUS_READ = 1;
    ...
    public static function create($name, $content = null, $userId = null, $fromId = null, $messageId = null)
    {
        ...
        $model->message_id = $messageId ?? Yii::$app->params['defaultFeedbackMessageId'];
