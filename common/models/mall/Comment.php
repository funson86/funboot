...
/**
 * This is the model class for table "{{%mall_comment}}".
 *
 * @property int $id
...
class Comment extends CommentBase
{
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['store_id', 'product_id', 'order_id', 'star', 'point', 'up', 'type', 'sort', 'status', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
