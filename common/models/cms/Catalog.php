...
class Catalog extends CatalogBase
{
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['store_id', 'parent_id', 'is_nav', 'page_size', 'sort', 'status', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
            [['name'], 'required'],
            [['banner', 'banner_h5'], 'safe'],
            [['seo_description', 'content'], 'string'],
            [['name', 'seo_title', 'seo_keywords', 'redirect_url', 'template', 'template_page', 'type'], 'string', 'max' => 255],
        ]);
    }
