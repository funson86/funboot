...
CREATE TABLE `fb_wechat_fan` (
  ...
  `tagid_list` json default null COMMENT '标签ID',
...
CREATE TABLE `fb_wechat_fan_tag` (
  ...
  CONSTRAINT `wechat_fan_tag_fk4` FOREIGN KEY (`tag_id`) REFERENCES `fb_wechat_tag` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `fb_wechat_qrcode` (
  ...
  `subscribe_count` int(11) NOT NULL DEFAULT 1 COMMENT '扫描次数',
  `type` int(11) NOT NULL DEFAULT 1 COMMENT '类型',
  `sort` int(11) NOT NULL DEFAULT 50 COMMENT '排序',
  `status` int(11) NOT NULL DEFAULT 1 COMMENT '状态',
  `created_at` int(11) NOT NULL DEFAULT '1' COMMENT '创建时间',
...
INSERT INTO `fb_base_permission` VALUES ('313', '1', '31', '粉丝标签', 'backend', '', '/wechat/fan-tag/index', 'fas fa-tags', '', '3', '0', '1', '50', '1', '1', '1599358085', '1', '1');
...
INSERT INTO `fb_base_permission` VALUES ('3131', '1', '313', '查看', 'backend', '', '/wechat/fan-tag/view*', '', '', '4', '0', '1', '50', '1', '1', '1', '1', '1');
INSERT INTO `fb_base_permission` VALUES ('3132', '1', '313', '编辑', 'backend', '', '/wechat/fan-tag/edit*', '', '', '4', '0', '1', '50', '1', '1', '1', '1', '1');
INSERT INTO `fb_base_permission` VALUES ('3133', '1', '313', '删除', 'backend', '', '/wechat/fan-tag/delete*', '', '', '4', '0', '1', '50', '1', '1', '1', '1', '1');
INSERT INTO `fb_base_permission` VALUES ('3134', '1', '313', '启禁', 'backend', '', '/wechat/fan-tag/status*', '', '', '4', '0', '1', '50', '1', '1', '1', '1', '1');
INSERT INTO `fb_base_permission` VALUES ('3135', '1', '313', '导出', 'backend', '', '/wechat/fan-tag/export*', '', '', '4', '0', '1', '50', '1', '1', '1', '1', '1');
INSERT INTO `fb_base_permission` VALUES ('3136', '1', '313', '导入', 'backend', '', '/wechat/fan-tag/import*', '', '', '4', '0', '1', '50', '1', '1', '1', '1', '1');
...
INSERT INTO `fb_base_setting_type` VALUES ('36', '1', '0', 'backend', '微信公众号', 'wechat', '', 'text', '', '', '50', '1', '1600948360', '1600948360', '1', '1');
INSERT INTO `fb_base_setting_type` VALUES ('38', '1', '0', 'backend', '微信小程序', 'mini', '', 'text', '', '', '50', '1', '1600948360', '1600948360', '1', '1');

INSERT INTO `fb_base_setting_type` VALUES ('3601', '1', '36', 'backend', '公众号帐号', 'wechat_account', '公众号帐号，一般为英文帐号或邮箱', 'text', '', '', '50', '1', '1600948383', '1600948392', '1', '1');
INSERT INTO `fb_base_setting_type` VALUES ('3603', '1', '36', 'backend', '公众号原始ID', 'wechat_id', '建议完善，给用户发客服消息时需要，位于右上角【帐号详情】》【注册信息】中', 'text', '', '', '50', '1', '1600948383', '1600948392', '1', '1');
INSERT INTO `fb_base_setting_type` VALUES ('3605', '1', '36', 'backend', '公众号原始ID', 'wechat_rank', '建议完善，给用户发客服消息时需要', 'text', '', '', '50', '1', '1600948383', '1600948392', '1', '1');
