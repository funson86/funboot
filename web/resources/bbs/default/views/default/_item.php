...
<div class="media text-muted">
    ...
    <div class="media-body small lh-125 border-gray">
        <div class="media-heading topic-title"><?= $model->grade > 0 ? Html::tag('span', '精', ['class' => 'badge badge-pill badge-info']) : '' ?><?= Html::a($model->name, ['/bbs/topic/view', 'id' => $model->id]) ?><?= $model->status == ActiveModel::STATUS_INACTIVE ? ' ' . Html::tag('span', Yii::t('app', 'Unverified'), ['class' => 'btn-warning pl-1 pr-1']) . ' ' . Html::a(Yii::t('app', 'Pass'), ['/bbs/topic/pass', 'id' => $model->id], ['class' => 'btn btn-sm btn-success']) : '' ?> </div>
