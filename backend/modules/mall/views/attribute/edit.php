...
use common\models\mall\Attribute as ActiveModel;
use common\models\base\Lang;

/* @var $this yii\web\View */
/* @var $model common\models\mall\Attribute */
/* @var $form yii\widgets\ActiveForm */

$this->title = ($model->id ? Yii::t('app', 'Edit ') : Yii::t('app', 'Create ')) . Yii::t('app', 'Attribute');
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane fade active show" id="tab-content-1">
                        ...
                        <?= $form->field($model, 'type')->radioList(ActiveModel::getTypeLabels()) ?>
