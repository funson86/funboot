            ...
            <div class="card-body">
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        // 'payment_method',
                        // 'payment_fee',
                        ['attribute' => 'payment_status', 'format' => 'raw', 'value' => function ($model) { return ActiveModel::getPaymentStatusLabels($model->payment_status) ? Html::status($model->payment_status) : ActiveModel::getStatusLabels($model->payment_status); }, 'filter' => Html::activeDropDownList($searchModel, 'payment_status', ActiveModel::getStatusLabels(), ['class' => 'form-control', 'prompt' => Yii::t('app', 'Please Filter')]),],
                        // 'paid_at:datetime',
                        // 'shipment_id',
                        // 'shipment_name',
                        // 'shipment_fee',
