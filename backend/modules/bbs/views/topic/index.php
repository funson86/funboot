            ...
            <div class="card-body">
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        ['attribute' => 'node_id', 'value' => function ($model) { return $model->node->name; }, 'filter' => Html::activeDropDownList($searchModel, 'node_id', \common\models\bbs\Node::getTreeIdLabel(0, false), ['class' => 'form-control', 'prompt' => Yii::t('app', 'Please Filter')]),],
